      ...
      <div className="flex max-h-[90vh] flex-col rounded-lg bg-surface-1">
        ...
        <div className="flex justify-between px-6 pt-4">
          <div>
            ...
            <p className="mt-1 text-13 text-tertiary">{t("navigation.customize.description")}</p>
          </div>
          <button
            onClick={onClose}
                ...
                <div className="space-y-2">
                  ...
                  <label className="flex cursor-pointer gap-2 rounded-md px-2 py-1.5 hover:bg-surface-2">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-11 text-secondary">{t("navigation.customize.accordion_description")}</div>
                    </div>
                  </label>
                  ...
                  <label className="flex cursor-pointer gap-2 rounded-md px-2 py-1.5 hover:bg-surface-2">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-11 text-secondary">{t("navigation.customize.tabbed_description")}</div>
                    </div>
                  </label>
                </div>
                      ...
                      <div className="flex w-full flex-col gap-1">
                        ...
                        {parseInt(projectCountInput) < 1 && projectCountInput !== "" && (
                          <span className="pl-0.5 text-11 text-danger-primary">
                            {t("navigation.customize.minimum_project_count")}
                          </span>
                        )}
                      </div>
                    </div>
