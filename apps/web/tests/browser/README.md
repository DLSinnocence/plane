...
The suite checks dropdown coordinates, option selection, timezone search/reopening, Escape, modal scrolling and resizing, invalid nested trigger markup, and administrator-only visibility of the integration link alongside Webhooks. No API server, credentials, or real workspace mutations are required.
