...
export default defineConfig({
  ...
  resolve: {
    alias: [
      ...
      { find: "@/hooks/store/use-editor-asset", replacement: path("./fixtures/editor-file-size-state.ts") },
      { find: "@/hooks/store/use-instance", replacement: path("./fixtures/editor-file-size-state.ts") },
      { find: "@/hooks/editor/use-extended-editor-config", replacement: path("./fixtures/editor-file-size-state.ts") },
